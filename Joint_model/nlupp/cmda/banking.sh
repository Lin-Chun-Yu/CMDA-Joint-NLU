...
#資料擴增
#python train.py -g -bs=4 -ne=100 -dd=./data/banking0 -lod=./log/banking/1 -sd=./save/banking -ws=3 -ln=sr0.1ri0.1rs0.1rd0.1cr0.1ro0.1sl0.4.txt -afp=./data_aug/banking0/1/sr0.1ri0.1rs0.1rd0.1cr0.1ro0.1sl0.4.txt
