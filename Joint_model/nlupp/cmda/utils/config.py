...
parser.add_argument("--random_state", '-rst', help='random seed', type=int, default=72)
...
parser.add_argument('--slot_embedding_dim', '-sed', type=int, default=128)
...
#資料增強
parser.add_argument('--intent_loss_alpha', '-lalpha', type=float, default=0.5)
parser.add_argument('--slot_loss_alpha', '-salpha', type=float, default=0.5)
parser.add_argument('--window_size', '-ws', type=int, default=3)#chunk
parser.add_argument('--aug_file_path', '-afp', type=str, default='None')
